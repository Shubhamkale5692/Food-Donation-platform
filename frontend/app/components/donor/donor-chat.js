// Donor Chat Functions - Add to DonorController scope
angular.module("foodBridgeApp").run(["$rootScope", "$timeout", "ChatService", "AuthService", function($rootScope, $timeout, ChatService, AuthService) {
    ...
    $rootScope.openChat = function(donation, targetRole) {
        console.log("Opening chat for donation:", donation, "with target role:", targetRole);
        ...
        console.log("Setting chatPanelOpen to true, current value:", $rootScope.chatPanelOpen);
        ...
        ChatService.getParticipants(donationId).then(function(res) {
            ...
            console.log("Participants fetched:", $rootScope.chatParticipants);
